...
const Hero = () => {
  const [text] = useTypewriter({
    words: ["Professional Developer", "Full Stack Engineer", "UI Architect"],
    loop: true,
    typeSpeed: 30,
    deleteSpeed: 20,
    delaySpeed: 2500,
        ...
        >
          <div className="flex flex-col gap-8">
            ...
            <h1 className="text-5xl xl:text-6xl font-bold text-white leading-tight">
              Hi, I'm <span className="text-blue-400">Biile Prince</span>
            </h1>
            ...
            <p className="text-base text-slate-400 leading-relaxed max-w-2xl">
              I architect immersive digital experiences through clean code and
              thoughtful design. Specializing in full-stack development, I
              bridge technical excellence with user-centric interfaces to create
          ...
          <div className="flex flex-col xl:flex-row gap-6 lg:gap-0 justify-between">
            ...
            <div>
              ...
              <div className="flex gap-4">
                {[FaReact, SiNextdotjs, SiTailwindcss, SiFigma].map(
                  (Icon, idx) => (
                    <motion.span
                      key={idx}
